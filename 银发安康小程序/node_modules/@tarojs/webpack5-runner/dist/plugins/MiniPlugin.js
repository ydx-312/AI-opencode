        ...
        if (independentPackageNames.length) {
            ...
            independentPackageNames.map(rootPath => {
                ...
                independentPagesCssAssets.forEach(assetPath => {
                    const relativePath = node_path_1.default.posix.relative(node_path_1.default.dirname(assetPath), rootPath) || '.';
                    const importStatement = `@import ${JSON.stringify((0, loader_utils_1.urlToRequest)(`${relativePath}/${commonCssFileName}`))};`;
